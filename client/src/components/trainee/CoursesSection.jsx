...
const CoursesSection = () => {
  ...
  return (
    <div className='py-16 md:px-40 px-8'>
      ...
      <p className='text-sm md:text-base text-gray-500 mt-3'>Discover our top-rated courses across various fields. From technology and design to business and professional skills, our programs are designed to help you succeed.</p>
